...
# set_property PACKAGE_PIN V5 [get_ports {number[7]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {number[7]}]
# #Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
# set_property PACKAGE_PIN U4 [get_ports {number[8]}]					
...
set_property PACKAGE_PIN T8 [get_ports {v_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {v_out}]
# #Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
# set_property PACKAGE_PIN V9 [get_ports {b_d[1]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[1]}]
# #Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
# set_property PACKAGE_PIN R8 [get_ports {b_d[2]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[2]}]
# #Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
# set_property PACKAGE_PIN T6 [get_ports {b_d[3]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[3]}]
# #Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
# set_property PACKAGE_PIN T5 [get_ports {b_d[4]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[4]}]
# #Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
# set_property PACKAGE_PIN T4 [get_ports {b_d[5]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[5]}]
# #Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
# set_property PACKAGE_PIN U7 [get_ports {b_d[6]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[6]}]
# #Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
# set_property PACKAGE_PIN U6 [get_ports {b_d[7]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b_d[7]}]
#Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
set_property PACKAGE_PIN V4 [get_ports {a_d[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[0]}]
#Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {a_d[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[1]}]
#Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {a_d[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[2]}]
#Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {a_d[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[3]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {a_d[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[4]}]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {a_d[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[5]}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {a_d[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[6]}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {a_d[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_d[7]}]
...
set_property PACKAGE_PIN E16 [get_ports latch]						
...
set_property PACKAGE_PIN A3 [get_ports {io_rgb_color[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[0]}]
#Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports {io_rgb_color[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[1]}]
#Bank = 35, Pin name = IO_L1N_T0_AD4N_35,					Sch name = VGA_R2
set_property PACKAGE_PIN C5 [get_ports {io_rgb_color[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[2]}]
#Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports {io_rgb_color[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[3]}]
	
#Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports {io_rgb_color[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[4]}]
#Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports {io_rgb_color[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[5]}]
#Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports {io_rgb_color[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[6]}]
#Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports {io_rgb_color[7]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[7]}]
	
#Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports {io_rgb_color[8]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[8]}]
#Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports {io_rgb_color[9]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[9]}]
#Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports {io_rgb_color[10]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[10]}]
#Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports {io_rgb_color[11]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {io_rgb_color[11]}]
	
#Bank = 15, Pin name = IO_L4P_T0_15,						Sch name = VGA_HS
set_property PACKAGE_PIN B11 [get_ports io_horizontal_sync]						
	set_property IOSTANDARD LVCMOS33 [get_ports io_horizontal_sync]
#Bank = 15, Pin name = IO_L3N_T0_DQS_AD1N_15,				Sch name = VGA_VS
set_property PACKAGE_PIN B12 [get_ports io_vertical_sync]						
	set_property IOSTANDARD LVCMOS33 [get_ports io_vertical_sync]
